...
Wordfeud Helper is a mobile Wordfeud helper for Android and iOS. Its differentiator is that it validates every word created by touching letters, rather than only checking whether the main word fits.

The product name is **Wordfeud Helper**. The target GitHub repository is **WFHelper**.
...
- A 457,739-entry Dutch Wordfeud dictionary is embedded offline from owner-authorized woordenlijst.org, Wordfeudwoorden.nl, and Wordfeudhelper.nl sources.
...
1. Keep the Dutch dictionary current and expand acceptance/rejection fixtures as the source sites evolve.
...
- Run the Wordfeud Helper typecheck after mobile code changes.
