...
const translations = {
  nl: {
    ...
    english: 'Engels',
    feedback: 'Beloningen',
    feedbackSubtitle: 'Kies welke feedback je krijgt na een sterke zet.',
    visualEffects: 'Visuele effecten',
    visualEffectsSubtitle: 'Confetti en vuurwerk bij hoge scores',
    soundEffects: 'Geluid',
    soundEffectsSubtitle: 'Een korte klank bij je score',
    hapticFeedback: 'Trillen',
    hapticFeedbackSubtitle: 'Voelbare feedback bij acties',
    personalBest: 'Persoonlijk record',
    rewardNice: 'Mooie zet',
    rewardGreat: 'Sterk gespeeld',
    rewardExcellent: 'Uitstekend',
    rewardAmazing: 'Geweldig',
    rewardHuge: 'Enorme score',
    rewardLegendary: 'Legendarisch',
    ...
    clearScreen: 'wis scherm',
    clearScreenTitle: 'Scherm wissen?',
    clearScreenMessage: 'Het bord, rek en alle scanresultaten worden gewist.',
    clearScreenConfirm: 'Wissen',
    cancel: 'Annuleren',
  ...
  en: {
    ...
    english: 'English',
    feedback: 'Rewards',
    feedbackSubtitle: 'Choose which feedback you get after a strong move.',
    visualEffects: 'Visual effects',
    visualEffectsSubtitle: 'Confetti and fireworks for high scores',
    soundEffects: 'Sound',
    soundEffectsSubtitle: 'A short cue for your score',
    hapticFeedback: 'Haptics',
    hapticFeedbackSubtitle: 'Tactile feedback for actions',
    personalBest: 'Personal best',
    rewardNice: 'Nice move',
    rewardGreat: 'Well played',
    rewardExcellent: 'Excellent',
    rewardAmazing: 'Amazing',
    rewardHuge: 'Huge score',
    rewardLegendary: 'Legendary',
    ...
    clearScreenTitle: 'Clear screen?',
    clearScreenMessage: 'The board, rack, and all scan results will be cleared.',
    clearScreenConfirm: 'Clear',
    cancel: 'Cancel',
    scanScreenshot: 'Scan Wordfeud screenshot',
